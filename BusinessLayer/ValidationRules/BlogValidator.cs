...
namespace BusinessLayer.ValidationRules
{
    public class BlogValidator:AbstractValidator<Blog>
    {
        ...
        {
            RuleFor(x => x.BlogTitle).NotEmpty().WithMessage("Blog başlığını boş geçmemelisiniz!");
            RuleFor(x => x.BlogContent).NotEmpty().WithMessage("Blog içeriğini boş geçmemelisiniz!");
            RuleFor(x => x.BlogTmage).NotEmpty().WithMessage("Blog resmini boş geçmemelisiniz!");
